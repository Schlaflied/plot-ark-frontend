...
const translations = {
    'zh-CN': {
        ...
        loginTitle: "登录方舟", registerTitle: "注册新账号", emailLabel: "邮箱", passwordLabel: "密码", loginButton: "登录", registerButton: "注册", switchToRegister: "还没有账号？点此注册", switchToLogin: "已有账号？点此登录", logoutButton: "登出", authError: "认证失败，请检查邮箱或密码。", registerSuccess: "注册成功！请登录。", guestModeButton: "游客模式", guestTriesLeft: "剩余免费次数：", noGuestTries: "免费次数已用完，请注册后继续使用。", historyButton: "历史记录", historyTitle: "灵感档案馆", loadButton: "加载此记录", emptyHistory: "你还没有任何创作记录哦，快去生成你的第一个大纲吧！", deleteButton: "删除", confirmDelete: "你确定要永久删除这条灵感记录吗？",
    },
    'zh-TW': {
