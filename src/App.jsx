...
const translations = {
  en: {
    ...
    error: 'Error',
    success: 'Success',
    registerSuccess: 'Registration successful! You have 3 free generation opportunities. Please check your email to activate your account.',
  ...
  zh_CN: {
    ...
    error: '错误',
    success: '成功',
    registerSuccess: '恭喜您注册成功！您有 3 次免费生成机会。请检查您的邮箱以激活账户。',
  ...
  zh_TW: {
    ...
    error: '錯誤',
    success: '成功',
    registerSuccess: '註冊成功！您有 3 次免費生成機會。請檢查您的郵箱以啟用帳戶。',
